...
const CompletePurchase = ({ quantityAdded }) => {
	return (
		<>
			{quantityAdded === 1 ? (
				<p className="">1 unidad agregada al carrito</p>
			) : (
				<p className="">{quantityAdded} unidades agregadas al carrito</p>
			)}
			<Link
				to="/cart"
				className="p-2 border-2 w-[150px] mt-[64px] mb-2 relative bg-transparent z-[2] button group transition-all duration-300 ease-in-out border-oscuro1 hover:text-white text-center">
